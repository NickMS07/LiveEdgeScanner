...
function detectSport(market) {
  ...
  // NHL
  if (text.includes('nhl') || text.includes('stanley cup') || text.includes('oilers') || text.includes('maple leafs') || text.includes('bruins') || text.includes('panthers') || text.includes('hurricanes') || text.includes('avalanche') || text.includes('stars') || text.includes('flames') || text.includes('penguins') || text.includes('rangers') || text.includes('devils') || text.includes('capitals') || text.includes('lightning') || text.includes('canadiens') || text.includes('red wings') || text.includes('blackhawks') || text.includes('canucks') || text.includes('senators') || text.includes('predators') || text.includes('blue jackets') || text.includes('islanders') || text.includes('flyers') || text.includes('wild') || text.includes('kraken') || text.includes('jets') || text.includes('sabres') || text.includes('golden knights') || text.includes('sharks') || text.includes('ducks') || text.includes('coyotes') || text.includes('blues')) return 'nhl';
  ...
  // UFC / MMA
  if (text.includes('ufc') || text.includes('mma') || text.includes('prochazka') || text.includes('ulberg') || text.includes('murzakanov') || text.includes('bellator') || text.includes('pfl') || text.includes('lightweight') || text.includes('heavyweight') || text.includes('middleweight') || text.includes('welterweight') || text.includes('featherweight') || text.includes('bantamweight') || text.includes('flyweight')) return 'ufc';
